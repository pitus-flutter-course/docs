...
> *(прим.) хочу обратить ваше вниманиче, что **Model** в архитектурных паттернах — это не просто данные или состояние экрана. Модель отвечает за **бизнес-> логику** и правила работы с данными. Это может включать валидацию, обработку данных, взаимодействие с базами данных или API.
